...
def FCRN_A_base(input):
    ...
    pool1 = MaxPooling2D(pool_size=(2,2))(block1) # 128
    # =========================================================================
    block2 = _conv_bn_relu(64,3,3)(pool1)
    pool2 = MaxPooling2D(pool_size=(2, 2))(block2) # 64
    # =========================================================================
    block3 = _conv_bn_relu(128,3,3)(pool2)
    pool3 = MaxPooling2D(pool_size=(2, 2))(block3) # 32
    # =========================================================================
    ...
    drop1 = Dropout(rate = 0.5)(block5)
    up5 = merge([UpSampling2D(size=(2, 2))(drop1), block2], mode='concat', concat_axis=-1)
    # =========================================================================
    up6 = UpSampling2D(size=(2, 2))(drop1)
    block6 = _conv_bn_relu(64,3,3)(up6)
    drop2 = Dropout(rate = 0.5)(block6)
    up6 = merge([UpSampling2D(size=(2, 2))(drop2), block1], mode='concat', concat_axis=-1)

    # =========================================================================
    up7 = UpSampling2D(size=(2, 2))(drop2)
    block7 = _conv_bn_relu(32,3,3)(up7)
    drop3 = Dropout(rate = 0.5)(block7)
    return drop3
...
def buildModel_FCRN_A (input_dim):
    ...
    # =========================================================================
    density_pred =  Convolution2D(1, 1, 1, bias = False, activation='linear',                                  init='orthogonal',name='pred',border_mode='same')(act_)
    # =========================================================================
