...
parser.add_argument("--model", help = "Model to Deploy in Test Data", required = True)
...
print("\nTest Loss: %.3f" %(valid_loss))
print("Test Accuracy: %.3f" %(valid_accuracy))
print("=" * 30, "\n")
...
cm_name = "./confusion/" + date + "-TEST-conf-matrix.npy"
