...
from ..utils.image import read_image_bgr, read_image_bgr_val
...
class CSVGenerator(Generator):
    ...
    def load_image(self, image_index,val=False):
        if val ==True:
          return read_image_bgr_val(self.image_path(image_index))
        else:
